## 1. create IAM Policy for nodes with the controlplane role:
...
## 2. create IAM policy for nodes with the etcd or worker role:
...
## 3. create IAM Role and attach the policy

## 4. attach the Role to EC2 Instance

## 5. Configuring the ClusterID
...
## 7. Set cloud providers to aws on Rancher